...
const DEVELOPMENT_PATH_PREFIX = 'http://localhost:8000'; // normally not to be changed, your assets should be provided directly within /dist/ (and not /dist/mymovies/ e.g.)
const PRODUCTION_PATH_PREFIX = '/Danish8Bits/'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name
